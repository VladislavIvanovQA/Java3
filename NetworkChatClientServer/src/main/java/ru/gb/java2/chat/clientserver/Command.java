...
public class Command implements Serializable {
    ...
    public static Command updateNickCommand(String newNick) {
        Command command = new Command();
        command.type = CommandType.CHANGE_NICK;
        command.data = new ChangeNickCommandData(newNick);
        return command;
    }

    public static Command updateNickOkCommand(String userName) {
        Command command = new Command();
        command.type = CommandType.CHANGE_NICK_OK;
        command.data = new ChangeNickCommandData(userName);
        return command;
    }
